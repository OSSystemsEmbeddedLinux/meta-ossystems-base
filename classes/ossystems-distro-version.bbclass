...
#
# This class is mainly used by ossystems-version.inc and recipes
# that includes it. Those need to define the PRODUCT variable
# that is used as tag prefix for matching on GIT.
#
